const About = () => {
  return (
    <div className="bg-primaryDark/80 w-fit mx-auto pb-24 rounded-xl">
      <div className="pt-24 relative flex flex-wrap md:flex-nowrap text-text mx-auto mt-12 sm:mt-18 md:mt-24 max-w-screen-lg gap-6 md:gap-12 md:px-10">
      ...
      <div className="relative max-w-screen-lg mx-auto px-8">
        ...
        <p className="text-center text-text text-lg pt-8 sm:pt-24">
          I'm a software engineer that excels in designing and creating
          exceptional digital experiences. Right now, I'm devoting my time and
          expertise to the open-source community, specifically toward my team's
          product, LogYard. I'd love to connect regarding potential
          opportunities so please feel free to reach out and connect!
        </p>
      </div>
    </div>
  );
